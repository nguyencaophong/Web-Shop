...
router.get('/edit-product/:productId', isAuth, checkRoleUser, adminController.getEditProduct);
...
router.delete('/delete-product/:productId', isAuth, checkRoleUser, adminController.deleteProduct);
